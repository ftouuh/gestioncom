    ...
    <div class="py-4">
            ...
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600"  style="width:100%; display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <div class="pr-4" style="margin-bottom:1rem;"><h1 style="font-size:30px; color:#191d3a;" class="whitespace-nowrap font-bold text-right">Facture</h1></div>
      ...
      <div class="px-14 py-10 text-sm text-neutral-700">
        <table class="w-full border-collapse border-spacing-0">
          <thead>
            <tr>
              <td class="border-b-2 border-main pb-3 pl-3 font-bold text-main">Référence</td>
              <td class="border-b-2 border-main pb-3 pl-2 font-bold text-main">Designation du Produit</td>
              <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Quantité</td>
              <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Prix</td>
              <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">SousTotal</td>
            </tr>
          </thead>
          <tbody>
            @php
            ...
            @foreach($dataArray as $p)
                <tr>
                <td class="border-b py-3 pl-3">{{$p[1]}}</td>
                <td class="border-b py-3 pl-2">{{$p[2]}}</td>
                <td class="border-b py-3 pl-2 text-right">{{$p[4]}}</td>
                <td class="border-b py-3 pl-2 text-center">{{$p[3]}}</td>
                <td class="border-b py-3 pl-2 text-center">
                    {{ number_format($p[4] * $p[3], 2)}}
                </td>
                </tr>
            @endforeach
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="bg-main p-3 text-right">
                                <div class="whitespace-nowrap font-bold text-white">{{$f['total_TTC']}} DH</div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
